...
char* update_originbalance_data_ToString(oms___rest_api___balance_data_UPDATEORIGIN_e update_origin) {
    char* update_originArray[] =  { "NULL", "INITIALIZATION", "BALANCE_MANAGER", "EXCHANGE" };
	return update_originArray[update_origin];
}

oms___rest_api___balance_data_UPDATEORIGIN_e update_originbalance_data_FromString(char* update_origin){
...
balance_data_t *balance_data_parseFromJSON(cJSON *balance_dataJSON){
    ...
    oms___rest_api___balance_data_UPDATEORIGIN_e update_originVariable;
    if (update_origin) { 
