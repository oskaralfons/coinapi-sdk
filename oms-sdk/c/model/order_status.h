...
typedef enum { oms___rest_api___order_status__NULL = 0, oms___rest_api___order_status__RECEIVED, oms___rest_api___order_status__ROUTING, oms___rest_api___order_status__ROUTED, oms___rest_api___order_status__NEW, oms___rest_api___order_status__PENDING_CANCEL, oms___rest_api___order_status__PARTIALLY_FILLED, oms___rest_api___order_status__FILLED, oms___rest_api___order_status__CANCELED, oms___rest_api___order_status__REJECTED } oms___rest_api___order_status__e;

char* order_status_order_status_ToString(oms___rest_api___order_status__e order_status);

oms___rest_api___order_status__e order_status_order_status_FromString(char* order_status);

//cJSON *order_status_order_status_convertToJSON(oms___rest_api___order_status__e order_status);

//oms___rest_api___order_status__e order_status_order_status_parseFromJSON(cJSON *order_statusJSON);
