...
typedef enum { oms___rest_api___time_in_force__NULL = 0, oms___rest_api___time_in_force__GOOD_TILL_CANCEL, oms___rest_api___time_in_force__GOOD_TILL_TIME_EXCHANGE, oms___rest_api___time_in_force__GOOD_TILL_TIME_OMS, oms___rest_api___time_in_force__FILL_OR_KILL, oms___rest_api___time_in_force__IMMEDIATE_OR_CANCEL, oms___rest_api___time_in_force__AUCTION_ONLY, oms___rest_api___time_in_force__INDICATION_OF_INTEREST } oms___rest_api___time_in_force__e;

char* time_in_force_time_in_force_ToString(oms___rest_api___time_in_force__e time_in_force);

oms___rest_api___time_in_force__e time_in_force_time_in_force_FromString(char* time_in_force);

//cJSON *time_in_force_time_in_force_convertToJSON(oms___rest_api___time_in_force__e time_in_force);

//oms___rest_api___time_in_force__e time_in_force_time_in_force_parseFromJSON(cJSON *time_in_forceJSON);
