...
char* statusorder_data_ToString(oeml___rest_api_order_data__e status) {
    char* statusArray[] =  { "NULL", "RECEIVED", "ROUTING", "ROUTED", "NEW", "PENDING_CANCEL", "PARTIALLY_FILLED", "FILLED", "CANCELED", "REJECTED" };
	return statusArray[status];
}

oeml___rest_api_order_data__e statusorder_data_FromString(char* status){
...
char* sideorder_data_ToString(oeml___rest_api_order_data_SIDE_e side) {
    char* sideArray[] =  { "NULL", "BUY", "SELL" };
	return sideArray[side];
}

oeml___rest_api_order_data_SIDE_e sideorder_data_FromString(char* side){
    int stringToReturn = 0;
    char *sideArray[] =  { "NULL", "BUY", "SELL" };
...
char* order_typeorder_data_ToString(oeml___rest_api_order_data_ORDERTYPE_e order_type) {
    char* order_typeArray[] =  { "NULL", "LIMIT" };
	return order_typeArray[order_type];
}

oeml___rest_api_order_data_ORDERTYPE_e order_typeorder_data_FromString(char* order_type){
    int stringToReturn = 0;
    char *order_typeArray[] =  { "NULL", "LIMIT" };
...
char* time_in_forceorder_data_ToString(oeml___rest_api_order_data__e time_in_force) {
...
oeml___rest_api_order_data__e time_in_forceorder_data_FromString(char* time_in_force){
    int stringToReturn = 0;
    char *time_in_forceArray[] =  { "NULL", "GOOD_TILL_CANCEL", "GOOD_TILL_TIME_EXCHANGE", "GOOD_TILL_TIME_OMS", "FILL_OR_KILL", "IMMEDIATE_OR_CANCEL", "AUCTION_ONLY", "INDICATION_OF_INTEREST" };
...
char* exec_instorder_data_ToString(oeml___rest_api_order_data_EXECINST_e exec_inst) {
	char *exec_instArray[] =  { "NULL", "MAKER_OR_CANCEL" };
	return exec_instArray[exec_inst - 1];
}

oeml___rest_api_order_data_EXECINST_e exec_instorder_data_FromString(char* exec_inst) {
    int stringToReturn = 0;
    char *exec_instArray[] =  { "NULL", "MAKER_OR_CANCEL" };
...
order_data_t *order_data_parseFromJSON(cJSON *order_dataJSON){
    ...
    oeml___rest_api_order_data_SIDE_e sideVariable;
    if (side) { 
    ...
    oeml___rest_api_order_data_ORDERTYPE_e order_typeVariable;
    if (order_type) { 
