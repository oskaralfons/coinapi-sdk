...
order_live_t* instantiate_order_live(int include_optional) {
  ...
  if (include_optional) {
    order_live = order_live_create(
      ...
      0.22,
      0.0,
      oms___rest_api___order_live__RECEIVED,
      list_create(),
      ...
      0.045,
      0.0783,
      oms___rest_api___order_live_SIDE_"BUY",
      oms___rest_api___order_live_ORDERTYPE_"LIMIT",
      oms___rest_api___order_live__GOOD_TILL_CANCEL,
      null,
      list_create()
    );
  } else {
