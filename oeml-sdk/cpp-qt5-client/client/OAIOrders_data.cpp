...
OAIOrders_data::OAIOrders_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrders_data::OAIOrders_data() {
    this->initializeModel();
}

OAIOrders_data::~OAIOrders_data() {}

void OAIOrders_data::initializeModel() {
...
void OAIOrders_data::fromJson(QString jsonString) {
...
void OAIOrders_data::fromJsonObject(QJsonObject json) {
...
QString OAIOrders_data::asJson() const {
...
QJsonObject OAIOrders_data::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOrders_data::getExchangeId() const {
    return exchange_id;
}
void OAIOrders_data::setExchangeId(const QString &exchange_id) {
    this->exchange_id = exchange_id;
    this->m_exchange_id_isSet = true;
}

bool OAIOrders_data::is_exchange_id_Set() const{
    return m_exchange_id_isSet;
}

bool OAIOrders_data::is_exchange_id_Valid() const{
    return m_exchange_id_isValid;
}

QString OAIOrders_data::getId() const {
    return id;
}
void OAIOrders_data::setId(const QString &id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool OAIOrders_data::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrders_data::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIOrders_data::getClientOrderIdFormatExchange() const {
    return client_order_id_format_exchange;
}
void OAIOrders_data::setClientOrderIdFormatExchange(const QString &client_order_id_format_exchange) {
    this->client_order_id_format_exchange = client_order_id_format_exchange;
    this->m_client_order_id_format_exchange_isSet = true;
}

bool OAIOrders_data::is_client_order_id_format_exchange_Set() const{
    return m_client_order_id_format_exchange_isSet;
}

bool OAIOrders_data::is_client_order_id_format_exchange_Valid() const{
    return m_client_order_id_format_exchange_isValid;
}

QString OAIOrders_data::getExchangeOrderId() const {
    return exchange_order_id;
}
void OAIOrders_data::setExchangeOrderId(const QString &exchange_order_id) {
    this->exchange_order_id = exchange_order_id;
    this->m_exchange_order_id_isSet = true;
}

bool OAIOrders_data::is_exchange_order_id_Set() const{
    return m_exchange_order_id_isSet;
}

bool OAIOrders_data::is_exchange_order_id_Valid() const{
    return m_exchange_order_id_isValid;
}

double OAIOrders_data::getAmountOpen() const {
    return amount_open;
}
void OAIOrders_data::setAmountOpen(const double &amount_open) {
    this->amount_open = amount_open;
    this->m_amount_open_isSet = true;
}

bool OAIOrders_data::is_amount_open_Set() const{
    return m_amount_open_isSet;
}

bool OAIOrders_data::is_amount_open_Valid() const{
    return m_amount_open_isValid;
}

double OAIOrders_data::getAmountFilled() const {
    return amount_filled;
}
void OAIOrders_data::setAmountFilled(const double &amount_filled) {
    this->amount_filled = amount_filled;
    this->m_amount_filled_isSet = true;
}

bool OAIOrders_data::is_amount_filled_Set() const{
    return m_amount_filled_isSet;
}

bool OAIOrders_data::is_amount_filled_Valid() const{
    return m_amount_filled_isValid;
}

OAIOrdStatus OAIOrders_data::getStatus() const {
    return status;
}
void OAIOrders_data::setStatus(const OAIOrdStatus &status) {
    this->status = status;
    this->m_status_isSet = true;
}

bool OAIOrders_data::is_status_Set() const{
    return m_status_isSet;
}

bool OAIOrders_data::is_status_Valid() const{
    return m_status_isValid;
}

QList<QList<QString>> OAIOrders_data::getTimeOrder() const {
    return time_order;
}
void OAIOrders_data::setTimeOrder(const QList<QList<QString>> &time_order) {
    this->time_order = time_order;
    this->m_time_order_isSet = true;
}

bool OAIOrders_data::is_time_order_Set() const{
    return m_time_order_isSet;
}

bool OAIOrders_data::is_time_order_Valid() const{
    return m_time_order_isValid;
}

QString OAIOrders_data::getErrorMessage() const {
    return error_message;
}
void OAIOrders_data::setErrorMessage(const QString &error_message) {
    this->error_message = error_message;
    this->m_error_message_isSet = true;
}

bool OAIOrders_data::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIOrders_data::is_error_message_Valid() const{
    return m_error_message_isValid;
}

QString OAIOrders_data::getClientOrderId() const {
    return client_order_id;
}
void OAIOrders_data::setClientOrderId(const QString &client_order_id) {
    this->client_order_id = client_order_id;
    this->m_client_order_id_isSet = true;
}

bool OAIOrders_data::is_client_order_id_Set() const{
    return m_client_order_id_isSet;
}

bool OAIOrders_data::is_client_order_id_Valid() const{
    return m_client_order_id_isValid;
}

QString OAIOrders_data::getSymbolExchange() const {
    return symbol_exchange;
}
void OAIOrders_data::setSymbolExchange(const QString &symbol_exchange) {
    this->symbol_exchange = symbol_exchange;
    this->m_symbol_exchange_isSet = true;
}

bool OAIOrders_data::is_symbol_exchange_Set() const{
    return m_symbol_exchange_isSet;
}

bool OAIOrders_data::is_symbol_exchange_Valid() const{
    return m_symbol_exchange_isValid;
}

QString OAIOrders_data::getSymbolCoinapi() const {
    return symbol_coinapi;
}
void OAIOrders_data::setSymbolCoinapi(const QString &symbol_coinapi) {
    this->symbol_coinapi = symbol_coinapi;
    this->m_symbol_coinapi_isSet = true;
}

bool OAIOrders_data::is_symbol_coinapi_Set() const{
    return m_symbol_coinapi_isSet;
}

bool OAIOrders_data::is_symbol_coinapi_Valid() const{
    return m_symbol_coinapi_isValid;
}

double OAIOrders_data::getAmountOrder() const {
    return amount_order;
}
void OAIOrders_data::setAmountOrder(const double &amount_order) {
    this->amount_order = amount_order;
    this->m_amount_order_isSet = true;
}

bool OAIOrders_data::is_amount_order_Set() const{
    return m_amount_order_isSet;
}

bool OAIOrders_data::is_amount_order_Valid() const{
    return m_amount_order_isValid;
}

double OAIOrders_data::getPrice() const {
    return price;
}
void OAIOrders_data::setPrice(const double &price) {
    this->price = price;
    this->m_price_isSet = true;
}

bool OAIOrders_data::is_price_Set() const{
    return m_price_isSet;
}

bool OAIOrders_data::is_price_Valid() const{
    return m_price_isValid;
}

QString OAIOrders_data::getSide() const {
    return side;
}
void OAIOrders_data::setSide(const QString &side) {
    this->side = side;
    this->m_side_isSet = true;
}

bool OAIOrders_data::is_side_Set() const{
    return m_side_isSet;
}

bool OAIOrders_data::is_side_Valid() const{
    return m_side_isValid;
}

QString OAIOrders_data::getOrderType() const {
    return order_type;
}
void OAIOrders_data::setOrderType(const QString &order_type) {
    this->order_type = order_type;
    this->m_order_type_isSet = true;
}

bool OAIOrders_data::is_order_type_Set() const{
    return m_order_type_isSet;
}

bool OAIOrders_data::is_order_type_Valid() const{
    return m_order_type_isValid;
}

OAITimeInForce OAIOrders_data::getTimeInForce() const {
    return time_in_force;
}
void OAIOrders_data::setTimeInForce(const OAITimeInForce &time_in_force) {
    this->time_in_force = time_in_force;
    this->m_time_in_force_isSet = true;
}

bool OAIOrders_data::is_time_in_force_Set() const{
    return m_time_in_force_isSet;
}

bool OAIOrders_data::is_time_in_force_Valid() const{
    return m_time_in_force_isValid;
}

QDate OAIOrders_data::getExpireTime() const {
    return expire_time;
}
void OAIOrders_data::setExpireTime(const QDate &expire_time) {
    this->expire_time = expire_time;
    this->m_expire_time_isSet = true;
}

bool OAIOrders_data::is_expire_time_Set() const{
    return m_expire_time_isSet;
}

bool OAIOrders_data::is_expire_time_Valid() const{
    return m_expire_time_isValid;
}

QList<QString> OAIOrders_data::getExecInst() const {
    return exec_inst;
}
void OAIOrders_data::setExecInst(const QList<QString> &exec_inst) {
    this->exec_inst = exec_inst;
    this->m_exec_inst_isSet = true;
}

bool OAIOrders_data::is_exec_inst_Set() const{
    return m_exec_inst_isSet;
}

bool OAIOrders_data::is_exec_inst_Valid() const{
    return m_exec_inst_isValid;
}

bool OAIOrders_data::isSet() const {
...
bool OAIOrders_data::isValid() const {
