...
void OAIExecutionReport::setExchangeId(const QString &exchange_id) {
    this->exchange_id = exchange_id;
    this->m_exchange_id_isSet = true;
}

bool OAIExecutionReport::is_exchange_id_Set() const{
    return m_exchange_id_isSet;
}

bool OAIExecutionReport::is_exchange_id_Valid() const{
...
void OAIExecutionReport::setClientOrderIdFormatExchange(const QString &client_order_id_format_exchange) {
    this->client_order_id_format_exchange = client_order_id_format_exchange;
    this->m_client_order_id_format_exchange_isSet = true;
}

bool OAIExecutionReport::is_client_order_id_format_exchange_Set() const{
    return m_client_order_id_format_exchange_isSet;
}

bool OAIExecutionReport::is_client_order_id_format_exchange_Valid() const{
    return m_client_order_id_format_exchange_isValid;
}

QString OAIExecutionReport::getExchangeOrderId() const {
    return exchange_order_id;
}
void OAIExecutionReport::setExchangeOrderId(const QString &exchange_order_id) {
    this->exchange_order_id = exchange_order_id;
    this->m_exchange_order_id_isSet = true;
}

bool OAIExecutionReport::is_exchange_order_id_Set() const{
    return m_exchange_order_id_isSet;
}

bool OAIExecutionReport::is_exchange_order_id_Valid() const{
    return m_exchange_order_id_isValid;
}

double OAIExecutionReport::getAmountOpen() const {
    return amount_open;
}
void OAIExecutionReport::setAmountOpen(const double &amount_open) {
    this->amount_open = amount_open;
    this->m_amount_open_isSet = true;
}

bool OAIExecutionReport::is_amount_open_Set() const{
    return m_amount_open_isSet;
}

bool OAIExecutionReport::is_amount_open_Valid() const{
    return m_amount_open_isValid;
}

double OAIExecutionReport::getAmountFilled() const {
    return amount_filled;
}
void OAIExecutionReport::setAmountFilled(const double &amount_filled) {
    this->amount_filled = amount_filled;
    this->m_amount_filled_isSet = true;
}

bool OAIExecutionReport::is_amount_filled_Set() const{
    return m_amount_filled_isSet;
}

bool OAIExecutionReport::is_amount_filled_Valid() const{
    return m_amount_filled_isValid;
}

OAIOrdStatus OAIExecutionReport::getStatus() const {
    return status;
}
void OAIExecutionReport::setStatus(const OAIOrdStatus &status) {
    this->status = status;
    this->m_status_isSet = true;
}

bool OAIExecutionReport::is_status_Set() const{
    return m_status_isSet;
}

bool OAIExecutionReport::is_status_Valid() const{
    return m_status_isValid;
}

QList<QList<QString>> OAIExecutionReport::getTimeOrder() const {
    return time_order;
}
void OAIExecutionReport::setTimeOrder(const QList<QList<QString>> &time_order) {
    this->time_order = time_order;
    this->m_time_order_isSet = true;
}

bool OAIExecutionReport::is_time_order_Set() const{
    return m_time_order_isSet;
}

bool OAIExecutionReport::is_time_order_Valid() const{
    return m_time_order_isValid;
}

QString OAIExecutionReport::getErrorMessage() const {
    return error_message;
}
void OAIExecutionReport::setErrorMessage(const QString &error_message) {
    this->error_message = error_message;
    this->m_error_message_isSet = true;
}

bool OAIExecutionReport::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIExecutionReport::is_error_message_Valid() const{
