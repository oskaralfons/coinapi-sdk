...
OAINewOrderSingle::OAINewOrderSingle(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewOrderSingle::OAINewOrderSingle() {
    this->initializeModel();
}

OAINewOrderSingle::~OAINewOrderSingle() {}

void OAINewOrderSingle::initializeModel() {
...
void OAINewOrderSingle::fromJson(QString jsonString) {
...
void OAINewOrderSingle::fromJsonObject(QJsonObject json) {
...
QString OAINewOrderSingle::asJson() const {
...
QJsonObject OAINewOrderSingle::asJsonObject() const {
    QJsonObject obj;
...
QString OAINewOrderSingle::getExchangeId() const {
    return exchange_id;
}
void OAINewOrderSingle::setExchangeId(const QString &exchange_id) {
    this->exchange_id = exchange_id;
    this->m_exchange_id_isSet = true;
}

bool OAINewOrderSingle::is_exchange_id_Set() const{
    return m_exchange_id_isSet;
}

bool OAINewOrderSingle::is_exchange_id_Valid() const{
    return m_exchange_id_isValid;
}

QString OAINewOrderSingle::getClientOrderId() const {
    return client_order_id;
}
void OAINewOrderSingle::setClientOrderId(const QString &client_order_id) {
    this->client_order_id = client_order_id;
    this->m_client_order_id_isSet = true;
}

bool OAINewOrderSingle::is_client_order_id_Set() const{
    return m_client_order_id_isSet;
}

bool OAINewOrderSingle::is_client_order_id_Valid() const{
    return m_client_order_id_isValid;
}

QString OAINewOrderSingle::getSymbolExchange() const {
    return symbol_exchange;
}
void OAINewOrderSingle::setSymbolExchange(const QString &symbol_exchange) {
    this->symbol_exchange = symbol_exchange;
    this->m_symbol_exchange_isSet = true;
}

bool OAINewOrderSingle::is_symbol_exchange_Set() const{
    return m_symbol_exchange_isSet;
}

bool OAINewOrderSingle::is_symbol_exchange_Valid() const{
    return m_symbol_exchange_isValid;
}

QString OAINewOrderSingle::getSymbolCoinapi() const {
    return symbol_coinapi;
}
void OAINewOrderSingle::setSymbolCoinapi(const QString &symbol_coinapi) {
    this->symbol_coinapi = symbol_coinapi;
    this->m_symbol_coinapi_isSet = true;
}

bool OAINewOrderSingle::is_symbol_coinapi_Set() const{
    return m_symbol_coinapi_isSet;
}

bool OAINewOrderSingle::is_symbol_coinapi_Valid() const{
    return m_symbol_coinapi_isValid;
}

double OAINewOrderSingle::getAmountOrder() const {
    return amount_order;
}
void OAINewOrderSingle::setAmountOrder(const double &amount_order) {
    this->amount_order = amount_order;
    this->m_amount_order_isSet = true;
}

bool OAINewOrderSingle::is_amount_order_Set() const{
    return m_amount_order_isSet;
}

bool OAINewOrderSingle::is_amount_order_Valid() const{
    return m_amount_order_isValid;
}

double OAINewOrderSingle::getPrice() const {
    return price;
}
void OAINewOrderSingle::setPrice(const double &price) {
    this->price = price;
    this->m_price_isSet = true;
}

bool OAINewOrderSingle::is_price_Set() const{
    return m_price_isSet;
}

bool OAINewOrderSingle::is_price_Valid() const{
    return m_price_isValid;
}

OAIOrdSide OAINewOrderSingle::getSide() const {
    return side;
}
void OAINewOrderSingle::setSide(const OAIOrdSide &side) {
    this->side = side;
    this->m_side_isSet = true;
}

bool OAINewOrderSingle::is_side_Set() const{
    return m_side_isSet;
}

bool OAINewOrderSingle::is_side_Valid() const{
    return m_side_isValid;
}

OAIOrdType OAINewOrderSingle::getOrderType() const {
    return order_type;
}
void OAINewOrderSingle::setOrderType(const OAIOrdType &order_type) {
    this->order_type = order_type;
    this->m_order_type_isSet = true;
}

bool OAINewOrderSingle::is_order_type_Set() const{
    return m_order_type_isSet;
}

bool OAINewOrderSingle::is_order_type_Valid() const{
    return m_order_type_isValid;
}

OAITimeInForce OAINewOrderSingle::getTimeInForce() const {
    return time_in_force;
}
void OAINewOrderSingle::setTimeInForce(const OAITimeInForce &time_in_force) {
    this->time_in_force = time_in_force;
    this->m_time_in_force_isSet = true;
}

bool OAINewOrderSingle::is_time_in_force_Set() const{
    return m_time_in_force_isSet;
}

bool OAINewOrderSingle::is_time_in_force_Valid() const{
    return m_time_in_force_isValid;
}

QDate OAINewOrderSingle::getExpireTime() const {
    return expire_time;
}
void OAINewOrderSingle::setExpireTime(const QDate &expire_time) {
    this->expire_time = expire_time;
    this->m_expire_time_isSet = true;
}

bool OAINewOrderSingle::is_expire_time_Set() const{
    return m_expire_time_isSet;
}

bool OAINewOrderSingle::is_expire_time_Valid() const{
    return m_expire_time_isValid;
}

QList<QString> OAINewOrderSingle::getExecInst() const {
    return exec_inst;
}
void OAINewOrderSingle::setExecInst(const QList<QString> &exec_inst) {
    this->exec_inst = exec_inst;
    this->m_exec_inst_isSet = true;
}

bool OAINewOrderSingle::is_exec_inst_Set() const{
    return m_exec_inst_isSet;
}

bool OAINewOrderSingle::is_exec_inst_Valid() const{
    return m_exec_inst_isValid;
}

bool OAINewOrderSingle::isSet() const {
...
bool OAINewOrderSingle::isValid() const {
