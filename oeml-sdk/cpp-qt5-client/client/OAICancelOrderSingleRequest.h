...
#define OAICancelOrderSingleRequest_H
...
class OAICancelOrderSingleRequest : public OAIObject {
public:
    OAICancelOrderSingleRequest();
    OAICancelOrderSingleRequest(QString json);
    ~OAICancelOrderSingleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelOrderSingleRequest)

#endif // OAICancelOrderSingleRequest_H
