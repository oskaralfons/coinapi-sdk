...
#define OAIExecutionReport_allOf_H
...
class OAIExecutionReport_allOf : public OAIObject {
public:
    OAIExecutionReport_allOf();
    OAIExecutionReport_allOf(QString json);
    ~OAIExecutionReport_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutionReport_allOf)

#endif // OAIExecutionReport_allOf_H
