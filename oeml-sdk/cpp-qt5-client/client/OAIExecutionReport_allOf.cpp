...
#include "OAIExecutionReport_allOf.h"
...
OAIExecutionReport_allOf::OAIExecutionReport_allOf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExecutionReport_allOf::OAIExecutionReport_allOf() {
    this->initializeModel();
}

OAIExecutionReport_allOf::~OAIExecutionReport_allOf() {}

void OAIExecutionReport_allOf::initializeModel() {
...
void OAIExecutionReport_allOf::fromJson(QString jsonString) {
...
void OAIExecutionReport_allOf::fromJsonObject(QJsonObject json) {
...
QString OAIExecutionReport_allOf::asJson() const {
...
QJsonObject OAIExecutionReport_allOf::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExecutionReport_allOf::getClientOrderIdFormatExchange() const {
    return client_order_id_format_exchange;
}
void OAIExecutionReport_allOf::setClientOrderIdFormatExchange(const QString &client_order_id_format_exchange) {
    this->client_order_id_format_exchange = client_order_id_format_exchange;
    this->m_client_order_id_format_exchange_isSet = true;
}

bool OAIExecutionReport_allOf::is_client_order_id_format_exchange_Set() const{
    return m_client_order_id_format_exchange_isSet;
}

bool OAIExecutionReport_allOf::is_client_order_id_format_exchange_Valid() const{
    return m_client_order_id_format_exchange_isValid;
}

QString OAIExecutionReport_allOf::getExchangeOrderId() const {
    return exchange_order_id;
}
void OAIExecutionReport_allOf::setExchangeOrderId(const QString &exchange_order_id) {
    this->exchange_order_id = exchange_order_id;
    this->m_exchange_order_id_isSet = true;
}

bool OAIExecutionReport_allOf::is_exchange_order_id_Set() const{
    return m_exchange_order_id_isSet;
}

bool OAIExecutionReport_allOf::is_exchange_order_id_Valid() const{
    return m_exchange_order_id_isValid;
}

double OAIExecutionReport_allOf::getAmountOpen() const {
    return amount_open;
}
void OAIExecutionReport_allOf::setAmountOpen(const double &amount_open) {
    this->amount_open = amount_open;
    this->m_amount_open_isSet = true;
}

bool OAIExecutionReport_allOf::is_amount_open_Set() const{
    return m_amount_open_isSet;
}

bool OAIExecutionReport_allOf::is_amount_open_Valid() const{
    return m_amount_open_isValid;
}

double OAIExecutionReport_allOf::getAmountFilled() const {
    return amount_filled;
}
void OAIExecutionReport_allOf::setAmountFilled(const double &amount_filled) {
    this->amount_filled = amount_filled;
    this->m_amount_filled_isSet = true;
}

bool OAIExecutionReport_allOf::is_amount_filled_Set() const{
    return m_amount_filled_isSet;
}

bool OAIExecutionReport_allOf::is_amount_filled_Valid() const{
    return m_amount_filled_isValid;
}

OAIOrdStatus OAIExecutionReport_allOf::getStatus() const {
    return status;
}
void OAIExecutionReport_allOf::setStatus(const OAIOrdStatus &status) {
    this->status = status;
    this->m_status_isSet = true;
}

bool OAIExecutionReport_allOf::is_status_Set() const{
    return m_status_isSet;
}

bool OAIExecutionReport_allOf::is_status_Valid() const{
    return m_status_isValid;
}

QList<QList<QString>> OAIExecutionReport_allOf::getTimeOrder() const {
    return time_order;
}
void OAIExecutionReport_allOf::setTimeOrder(const QList<QList<QString>> &time_order) {
    this->time_order = time_order;
    this->m_time_order_isSet = true;
}

bool OAIExecutionReport_allOf::is_time_order_Set() const{
    return m_time_order_isSet;
}

bool OAIExecutionReport_allOf::is_time_order_Valid() const{
    return m_time_order_isValid;
}

QString OAIExecutionReport_allOf::getErrorMessage() const {
    return error_message;
}
void OAIExecutionReport_allOf::setErrorMessage(const QString &error_message) {
    this->error_message = error_message;
    this->m_error_message_isSet = true;
}

bool OAIExecutionReport_allOf::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIExecutionReport_allOf::is_error_message_Valid() const{
    return m_error_message_isValid;
}

bool OAIExecutionReport_allOf::isSet() const {
