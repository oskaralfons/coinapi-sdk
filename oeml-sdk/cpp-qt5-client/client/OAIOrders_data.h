...
#ifndef OAIOrders_data_H
#define OAIOrders_data_H
...
class OAIOrders_data : public OAIObject {
public:
    OAIOrders_data();
    OAIOrders_data(QString json);
    ~OAIOrders_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrders_data)

#endif // OAIOrders_data_H
