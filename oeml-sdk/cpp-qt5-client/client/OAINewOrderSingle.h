...
class OAINewOrderSingle : public OAIObject {
public:
    OAINewOrderSingle();
    OAINewOrderSingle(QString json);
    ~OAINewOrderSingle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewOrderSingle)

#endif // OAINewOrderSingle_H
