...
public class OrdersData {
  ...
  public boolean equals(Object o) {
    ...
    return (this.exchangeId == null ? ordersData.exchangeId == null : this.exchangeId.equals(ordersData.exchangeId)) &&
        (this.id == null ? ordersData.id == null : this.id.equals(ordersData.id)) &&
        (this.clientOrderIdFormatExchange == null ? ordersData.clientOrderIdFormatExchange == null : this.clientOrderIdFormatExchange.equals(ordersData.clientOrderIdFormatExchange)) &&
        (this.exchangeOrderId == null ? ordersData.exchangeOrderId == null : this.exchangeOrderId.equals(ordersData.exchangeOrderId)) &&
        (this.amountOpen == null ? ordersData.amountOpen == null : this.amountOpen.equals(ordersData.amountOpen)) &&
        (this.amountFilled == null ? ordersData.amountFilled == null : this.amountFilled.equals(ordersData.amountFilled)) &&
        (this.status == null ? ordersData.status == null : this.status.equals(ordersData.status)) &&
        (this.timeOrder == null ? ordersData.timeOrder == null : this.timeOrder.equals(ordersData.timeOrder)) &&
        (this.errorMessage == null ? ordersData.errorMessage == null : this.errorMessage.equals(ordersData.errorMessage)) &&
        (this.clientOrderId == null ? ordersData.clientOrderId == null : this.clientOrderId.equals(ordersData.clientOrderId)) &&
        (this.symbolExchange == null ? ordersData.symbolExchange == null : this.symbolExchange.equals(ordersData.symbolExchange)) &&
        (this.symbolCoinapi == null ? ordersData.symbolCoinapi == null : this.symbolCoinapi.equals(ordersData.symbolCoinapi)) &&
        (this.amountOrder == null ? ordersData.amountOrder == null : this.amountOrder.equals(ordersData.amountOrder)) &&
        (this.price == null ? ordersData.price == null : this.price.equals(ordersData.price)) &&
        (this.side == null ? ordersData.side == null : this.side.equals(ordersData.side)) &&
        (this.orderType == null ? ordersData.orderType == null : this.orderType.equals(ordersData.orderType)) &&
        (this.timeInForce == null ? ordersData.timeInForce == null : this.timeInForce.equals(ordersData.timeInForce)) &&
        (this.expireTime == null ? ordersData.expireTime == null : this.expireTime.equals(ordersData.expireTime)) &&
        (this.execInst == null ? ordersData.execInst == null : this.execInst.equals(ordersData.execInst));
  }
