...
void
NewOrderSingle::fromJson(char* jsonStr)
{
...
NewOrderSingle::NewOrderSingle(char* json)
{
	this->fromJson(json);
}

char*
NewOrderSingle::toJson()
{
...
std::string
NewOrderSingle::getExchangeId()
{
	return exchange_id;
}

void
NewOrderSingle::setExchangeId(std::string  exchange_id)
{
	this->exchange_id = exchange_id;
}

std::string
NewOrderSingle::getClientOrderId()
{
	return client_order_id;
}

void
NewOrderSingle::setClientOrderId(std::string  client_order_id)
{
	this->client_order_id = client_order_id;
}

std::string
NewOrderSingle::getSymbolExchange()
{
	return symbol_exchange;
}

void
NewOrderSingle::setSymbolExchange(std::string  symbol_exchange)
{
	this->symbol_exchange = symbol_exchange;
}

std::string
NewOrderSingle::getSymbolCoinapi()
{
	return symbol_coinapi;
}

void
NewOrderSingle::setSymbolCoinapi(std::string  symbol_coinapi)
{
	this->symbol_coinapi = symbol_coinapi;
}

long long
NewOrderSingle::getAmountOrder()
{
	return amount_order;
}

void
NewOrderSingle::setAmountOrder(long long  amount_order)
{
	this->amount_order = amount_order;
}

long long
NewOrderSingle::getPrice()
{
	return price;
}

void
NewOrderSingle::setPrice(long long  price)
{
	this->price = price;
}
...
void
NewOrderSingle::setSide(OrdSide  side)
{
	this->side = side;
}

OrdType
NewOrderSingle::getOrderType()
{
	return order_type;
}

void
NewOrderSingle::setOrderType(OrdType  order_type)
{
	this->order_type = order_type;
}

TimeInForce
NewOrderSingle::getTimeInForce()
{
	return time_in_force;
}

void
NewOrderSingle::setTimeInForce(TimeInForce  time_in_force)
{
	this->time_in_force = time_in_force;
}

Date
NewOrderSingle::getExpireTime()
{
	return expire_time;
}

void
NewOrderSingle::setExpireTime(Date  expire_time)
{
	this->expire_time = expire_time;
}

std::list<std::string>
NewOrderSingle::getExecInst()
{
	return exec_inst;
}

void
NewOrderSingle::setExecInst(std::list <std::string> exec_inst)
{
