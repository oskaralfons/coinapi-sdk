...
std::string
OrderNewSingleRequest::getSymbolExchange()
{
	return symbol_exchange;
}

void
OrderNewSingleRequest::setSymbolExchange(std::string  symbol_exchange)
{
	this->symbol_exchange = symbol_exchange;
}

std::string
OrderNewSingleRequest::getSymbolCoinapi()
{
	return symbol_coinapi;
}

void
OrderNewSingleRequest::setSymbolCoinapi(std::string  symbol_coinapi)
{
