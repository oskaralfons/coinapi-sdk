...
void
Orders_data::fromJson(char* jsonStr)
{
...
Orders_data::Orders_data(char* json)
{
	this->fromJson(json);
}
...
std::string
Orders_data::getExchangeId()
{
	return exchange_id;
}

void
Orders_data::setExchangeId(std::string  exchange_id)
{
...
void
Orders_data::setId(std::string  id)
{
	this->id = id;
}

std::string
Orders_data::getClientOrderIdFormatExchange()
{
	return client_order_id_format_exchange;
}

void
Orders_data::setClientOrderIdFormatExchange(std::string  client_order_id_format_exchange)
{
	this->client_order_id_format_exchange = client_order_id_format_exchange;
}

std::string
Orders_data::getExchangeOrderId()
{
	return exchange_order_id;
}

void
Orders_data::setExchangeOrderId(std::string  exchange_order_id)
{
	this->exchange_order_id = exchange_order_id;
}

long long
Orders_data::getAmountOpen()
{
	return amount_open;
}

void
Orders_data::setAmountOpen(long long  amount_open)
{
	this->amount_open = amount_open;
}

long long
Orders_data::getAmountFilled()
{
	return amount_filled;
}

void
Orders_data::setAmountFilled(long long  amount_filled)
{
	this->amount_filled = amount_filled;
}

OrdStatus
Orders_data::getStatus()
{
	return status;
}

void
Orders_data::setStatus(OrdStatus  status)
{
	this->status = status;
}

std::list<std::list>
Orders_data::getTimeOrder()
{
	return time_order;
}

void
Orders_data::setTimeOrder(std::list <std::list> time_order)
{
	this->time_order = time_order;
}

std::string
Orders_data::getErrorMessage()
{
	return error_message;
}

void
Orders_data::setErrorMessage(std::string  error_message)
{
	this->error_message = error_message;
}

std::string
Orders_data::getClientOrderId()
{
	return client_order_id;
}

void
Orders_data::setClientOrderId(std::string  client_order_id)
{
	this->client_order_id = client_order_id;
}

std::string
Orders_data::getSymbolExchange()
{
	return symbol_exchange;
}

void
Orders_data::setSymbolExchange(std::string  symbol_exchange)
{
	this->symbol_exchange = symbol_exchange;
}

std::string
Orders_data::getSymbolCoinapi()
{
	return symbol_coinapi;
}

void
Orders_data::setSymbolCoinapi(std::string  symbol_coinapi)
{
	this->symbol_coinapi = symbol_coinapi;
}

long long
Orders_data::getAmountOrder()
{
	return amount_order;
}

void
Orders_data::setAmountOrder(long long  amount_order)
{
	this->amount_order = amount_order;
}

long long
Orders_data::getPrice()
{
	return price;
}

void
Orders_data::setPrice(long long  price)
{
	this->price = price;
}
...
void
Orders_data::setSide(std::string  side)
{
	this->side = side;
}

std::string
Orders_data::getOrderType()
{
	return order_type;
}

void
Orders_data::setOrderType(std::string  order_type)
{
	this->order_type = order_type;
}

TimeInForce
Orders_data::getTimeInForce()
{
	return time_in_force;
}

void
Orders_data::setTimeInForce(TimeInForce  time_in_force)
{
	this->time_in_force = time_in_force;
}

Date
Orders_data::getExpireTime()
{
	return expire_time;
}

void
Orders_data::setExpireTime(Date  expire_time)
{
	this->expire_time = expire_time;
}

std::list<std::string>
Orders_data::getExecInst()
{
	return exec_inst;
}

void
Orders_data::setExecInst(std::list <std::string> exec_inst)
{
