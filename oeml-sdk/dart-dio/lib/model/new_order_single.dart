...
part 'new_order_single.g.dart';

abstract class NewOrderSingle implements Built<NewOrderSingle, NewOrderSingleBuilder> {
    ...
    factory NewOrderSingle([updates(NewOrderSingleBuilder b)]) = _$NewOrderSingle;
    static Serializer<NewOrderSingle> get serializer => _$newOrderSingleSerializer;
