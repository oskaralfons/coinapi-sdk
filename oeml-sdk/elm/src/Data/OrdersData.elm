...
module Data.OrdersData exposing (OrdersData, Side(..), OrderType(..), ExecInst(..), decoder, encode, encodeWithTag, toString)
...
decoder : Decoder OrdersData
decoder =
    Decode.succeed OrdersData
...
encode : OrdersData -> Encode.Value
encode =
    Encode.object << encodePairs


encodeWithTag : ( String, String ) -> OrdersData -> Encode.Value
encodeWithTag (tagField, tag) model =
    Encode.object <| encodePairs model ++ [ ( tagField, Encode.string tag ) ]


encodePairs : OrdersData -> List (String, Encode.Value)
encodePairs model =
