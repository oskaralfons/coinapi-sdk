...
module Data.NewOrderSingle exposing (NewOrderSingle, ExecInst(..), decoder, encode, encodeWithTag, toString)
...
decoder : Decoder NewOrderSingle
decoder =
    Decode.succeed NewOrderSingle
...
encode : NewOrderSingle -> Encode.Value
encode =
    Encode.object << encodePairs


encodeWithTag : ( String, String ) -> NewOrderSingle -> Encode.Value
encodeWithTag (tagField, tag) model =
    Encode.object <| encodePairs model ++ [ ( tagField, Encode.string tag ) ]


encodePairs : NewOrderSingle -> List (String, Encode.Value)
encodePairs model =
...
toString : NewOrderSingle -> String
toString =
