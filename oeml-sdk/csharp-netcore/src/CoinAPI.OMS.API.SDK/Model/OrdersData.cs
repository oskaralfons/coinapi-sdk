...
namespace CoinAPI.OMS.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrdersData :  IEquatable<OrdersData>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrdersData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OrdersData);
        }

        /// <summary>
        /// Returns true if OrdersData instances are equal
        /// </summary>
        /// <param name="input">Instance of OrdersData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrdersData input)
        {
            if (input == null)
                return false;
