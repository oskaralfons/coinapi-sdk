...
OrdersData <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      OrdersDataObject <- list()
      if (!is.null(self$`exchange_id`)) {
        OrdersDataObject[['exchange_id']] <-
          self$`exchange_id`
      }
      if (!is.null(self$`id`)) {
        OrdersDataObject[['id']] <-
      ...
      if (!is.null(self$`client_order_id_format_exchange`)) {
        OrdersDataObject[['client_order_id_format_exchange']] <-
          self$`client_order_id_format_exchange`
      }
      if (!is.null(self$`exchange_order_id`)) {
        OrdersDataObject[['exchange_order_id']] <-
          self$`exchange_order_id`
      }
      if (!is.null(self$`amount_open`)) {
        OrdersDataObject[['amount_open']] <-
          self$`amount_open`
      }
      if (!is.null(self$`amount_filled`)) {
        OrdersDataObject[['amount_filled']] <-
          self$`amount_filled`
      }
      if (!is.null(self$`status`)) {
        OrdersDataObject[['status']] <-
          self$`status`$toJSON()
      }
      if (!is.null(self$`time_order`)) {
        OrdersDataObject[['time_order']] <-
          lapply(self$`time_order`, function(x) x$toJSON())
      }
      if (!is.null(self$`error_message`)) {
        OrdersDataObject[['error_message']] <-
          self$`error_message`
      }
      if (!is.null(self$`client_order_id`)) {
        OrdersDataObject[['client_order_id']] <-
          self$`client_order_id`
      }
      if (!is.null(self$`symbol_exchange`)) {
        OrdersDataObject[['symbol_exchange']] <-
          self$`symbol_exchange`
      }
      if (!is.null(self$`symbol_coinapi`)) {
        OrdersDataObject[['symbol_coinapi']] <-
          self$`symbol_coinapi`
      }
      if (!is.null(self$`amount_order`)) {
        OrdersDataObject[['amount_order']] <-
          self$`amount_order`
      }
      if (!is.null(self$`price`)) {
        OrdersDataObject[['price']] <-
          self$`price`
      }
      if (!is.null(self$`side`)) {
        OrdersDataObject[['side']] <-
          self$`side`
      }
      if (!is.null(self$`order_type`)) {
        OrdersDataObject[['order_type']] <-
          self$`order_type`
      }
      if (!is.null(self$`time_in_force`)) {
        OrdersDataObject[['time_in_force']] <-
          self$`time_in_force`$toJSON()
      }
      if (!is.null(self$`expire_time`)) {
        OrdersDataObject[['expire_time']] <-
          self$`expire_time`
      }
      if (!is.null(self$`exec_inst`)) {
        OrdersDataObject[['exec_inst']] <-
          self$`exec_inst`
      }

      OrdersDataObject
    },
    fromJSON = function(OrdersDataJson) {
      OrdersDataObject <- jsonlite::fromJSON(OrdersDataJson)
      if (!is.null(OrdersDataObject$`exchange_id`)) {
        self$`exchange_id` <- OrdersDataObject$`exchange_id`
      }
      if (!is.null(OrdersDataObject$`id`)) {
        self$`id` <- OrdersDataObject$`id`
      }
      if (!is.null(OrdersDataObject$`client_order_id_format_exchange`)) {
        self$`client_order_id_format_exchange` <- OrdersDataObject$`client_order_id_format_exchange`
      }
      if (!is.null(OrdersDataObject$`exchange_order_id`)) {
        self$`exchange_order_id` <- OrdersDataObject$`exchange_order_id`
      }
      if (!is.null(OrdersDataObject$`amount_open`)) {
        self$`amount_open` <- OrdersDataObject$`amount_open`
      }
      if (!is.null(OrdersDataObject$`amount_filled`)) {
        self$`amount_filled` <- OrdersDataObject$`amount_filled`
      }
      if (!is.null(OrdersDataObject$`status`)) {
        statusObject <- OrdStatus$new()
        statusObject$fromJSON(jsonlite::toJSON(OrdersDataObject$status, auto_unbox = TRUE, digits = NA))
        self$`status` <- statusObject
      }
      if (!is.null(OrdersDataObject$`time_order`)) {
        self$`time_order` <- ApiClient$new()$deserializeObj(OrdersDataObject$`time_order`, "array[array[character]]", loadNamespace("openapi"))
      }
      if (!is.null(OrdersDataObject$`error_message`)) {
        self$`error_message` <- OrdersDataObject$`error_message`
      }
      if (!is.null(OrdersDataObject$`client_order_id`)) {
        self$`client_order_id` <- OrdersDataObject$`client_order_id`
      }
      if (!is.null(OrdersDataObject$`symbol_exchange`)) {
        self$`symbol_exchange` <- OrdersDataObject$`symbol_exchange`
      }
      if (!is.null(OrdersDataObject$`symbol_coinapi`)) {
        self$`symbol_coinapi` <- OrdersDataObject$`symbol_coinapi`
      }
      if (!is.null(OrdersDataObject$`amount_order`)) {
        self$`amount_order` <- OrdersDataObject$`amount_order`
      }
      if (!is.null(OrdersDataObject$`price`)) {
        self$`price` <- OrdersDataObject$`price`
      }
      if (!is.null(OrdersDataObject$`side`)) {
        self$`side` <- OrdersDataObject$`side`
      }
      if (!is.null(OrdersDataObject$`order_type`)) {
        self$`order_type` <- OrdersDataObject$`order_type`
      }
      if (!is.null(OrdersDataObject$`time_in_force`)) {
        time_in_forceObject <- TimeInForce$new()
        time_in_forceObject$fromJSON(jsonlite::toJSON(OrdersDataObject$time_in_force, auto_unbox = TRUE, digits = NA))
        self$`time_in_force` <- time_in_forceObject
      }
      if (!is.null(OrdersDataObject$`expire_time`)) {
        self$`expire_time` <- OrdersDataObject$`expire_time`
      }
      if (!is.null(OrdersDataObject$`exec_inst`)) {
        self$`exec_inst` <- ApiClient$new()$deserializeObj(OrdersDataObject$`exec_inst`, "array[character]", loadNamespace("openapi"))
      }
    },
...
',
    ...
    fromJSONString = function(OrdersDataJson) {
      OrdersDataObject <- jsonlite::fromJSON(OrdersDataJson)
      self$`exchange_id` <- OrdersDataObject$`exchange_id`
      self$`id` <- OrdersDataObject$`id`
      self$`client_order_id_format_exchange` <- OrdersDataObject$`client_order_id_format_exchange`
      ...
      self$`amount_open` <- OrdersDataObject$`amount_open`
      self$`amount_filled` <- OrdersDataObject$`amount_filled`
      self$`status` <- OrdStatus$new()$fromJSON(jsonlite::toJSON(OrdersDataObject$status, auto_unbox = TRUE, digits = NA))
      self$`time_order` <- ApiClient$new()$deserializeObj(OrdersDataObject$`time_order`, "array[array[character]]", loadNamespace("openapi"))
      self$`error_message` <- OrdersDataObject$`error_message`
      self$`client_order_id` <- OrdersDataObject$`client_order_id`
      self$`symbol_exchange` <- OrdersDataObject$`symbol_exchange`
      ...
      self$`side` <- OrdersDataObject$`side`
      self$`order_type` <- OrdersDataObject$`order_type`
      self$`time_in_force` <- TimeInForce$new()$fromJSON(jsonlite::toJSON(OrdersDataObject$time_in_force, auto_unbox = TRUE, digits = NA))
      self$`expire_time` <- OrdersDataObject$`expire_time`
      self$`exec_inst` <- ApiClient$new()$deserializeObj(OrdersDataObject$`exec_inst`, "array[character]", loadNamespace("openapi"))
      self
    }
