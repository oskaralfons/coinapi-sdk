...
__PACKAGE__->class_documentation({description => 'Order statuses and the lifecycle are documented in the separate section: https://docs.coinapi.io/#oeml-order-lifecycle ',
                                  class => 'OrderStatus',
                                  required => [], # TODO
}                                 );
