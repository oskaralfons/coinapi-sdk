...
__PACKAGE__->class_documentation({description => 'Order time in force options are documented in the separate section: &lt;a href&#x3D;\&quot;#oeml-order-lifecycle\&quot;&gt;OEML / Starter Guide / Order parameters / Time in force&lt;/a&gt; ',
                                  class => 'TimeInForce',
                                  required => [], # TODO
}                                 );
