...
void ExecutionReport_allOf::validate()
{
    // TODO: implement validation
}

web::json::value ExecutionReport_allOf::toJson() const
{
...
bool ExecutionReport_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ExecutionReport_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExecutionReport_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t ExecutionReport_allOf::getClientOrderIdFormatExchange() const
{
    return m_Client_order_id_format_exchange;
}

void ExecutionReport_allOf::setClientOrderIdFormatExchange(const utility::string_t& value)
{
    m_Client_order_id_format_exchange = value;
    m_Client_order_id_format_exchangeIsSet = true;
}

bool ExecutionReport_allOf::clientOrderIdFormatExchangeIsSet() const
{
    return m_Client_order_id_format_exchangeIsSet;
}

void ExecutionReport_allOf::unsetClient_order_id_format_exchange()
{
    m_Client_order_id_format_exchangeIsSet = false;
}
utility::string_t ExecutionReport_allOf::getExchangeOrderId() const
{
    return m_Exchange_order_id;
}

void ExecutionReport_allOf::setExchangeOrderId(const utility::string_t& value)
{
    m_Exchange_order_id = value;
    m_Exchange_order_idIsSet = true;
}

bool ExecutionReport_allOf::exchangeOrderIdIsSet() const
{
    return m_Exchange_order_idIsSet;
}

void ExecutionReport_allOf::unsetExchange_order_id()
{
    m_Exchange_order_idIsSet = false;
}
double ExecutionReport_allOf::getAmountOpen() const
{
    return m_Amount_open;
}

void ExecutionReport_allOf::setAmountOpen(double value)
{
    m_Amount_open = value;
    m_Amount_openIsSet = true;
}

bool ExecutionReport_allOf::amountOpenIsSet() const
{
    return m_Amount_openIsSet;
}

void ExecutionReport_allOf::unsetAmount_open()
{
    m_Amount_openIsSet = false;
}
double ExecutionReport_allOf::getAmountFilled() const
{
    return m_Amount_filled;
}

void ExecutionReport_allOf::setAmountFilled(double value)
{
    m_Amount_filled = value;
    m_Amount_filledIsSet = true;
}

bool ExecutionReport_allOf::amountFilledIsSet() const
{
    return m_Amount_filledIsSet;
}

void ExecutionReport_allOf::unsetAmount_filled()
{
    m_Amount_filledIsSet = false;
}
std::shared_ptr<OrdStatus> ExecutionReport_allOf::getStatus() const
{
    return m_Status;
}

void ExecutionReport_allOf::setStatus(const std::shared_ptr<OrdStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ExecutionReport_allOf::statusIsSet() const
{
    return m_StatusIsSet;
}

void ExecutionReport_allOf::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::vector<utility::string_t>>& ExecutionReport_allOf::getTimeOrder()
{
    return m_Time_order;
}

void ExecutionReport_allOf::setTimeOrder(const std::vector<std::vector<utility::string_t>>& value)
{
    m_Time_order = value;
    m_Time_orderIsSet = true;
}

bool ExecutionReport_allOf::timeOrderIsSet() const
{
    return m_Time_orderIsSet;
}

void ExecutionReport_allOf::unsetTime_order()
{
    m_Time_orderIsSet = false;
}
utility::string_t ExecutionReport_allOf::getErrorMessage() const
{
    return m_Error_message;
}

void ExecutionReport_allOf::setErrorMessage(const utility::string_t& value)
{
    m_Error_message = value;
    m_Error_messageIsSet = true;
}

bool ExecutionReport_allOf::errorMessageIsSet() const
{
    return m_Error_messageIsSet;
}

void ExecutionReport_allOf::unsetError_message()
{
    m_Error_messageIsSet = false;
}
}
