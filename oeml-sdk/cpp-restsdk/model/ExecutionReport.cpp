...
void ExecutionReport::validate()
{
    // TODO: implement validation
}

web::json::value ExecutionReport::toJson() const
{
...
bool ExecutionReport::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ExecutionReport::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ExecutionReport::setExchangeId(const utility::string_t& value)
{
    m_Exchange_id = value;
    m_Exchange_idIsSet = true;
}

bool ExecutionReport::exchangeIdIsSet() const
{
    return m_Exchange_idIsSet;
}

void ExecutionReport::unsetExchange_id()
{
    m_Exchange_idIsSet = false;
}
...
void ExecutionReport::setClientOrderIdFormatExchange(const utility::string_t& value)
{
    m_Client_order_id_format_exchange = value;
    m_Client_order_id_format_exchangeIsSet = true;
}

bool ExecutionReport::clientOrderIdFormatExchangeIsSet() const
{
    return m_Client_order_id_format_exchangeIsSet;
}

void ExecutionReport::unsetClient_order_id_format_exchange()
{
    m_Client_order_id_format_exchangeIsSet = false;
}
utility::string_t ExecutionReport::getExchangeOrderId() const
{
    return m_Exchange_order_id;
}

void ExecutionReport::setExchangeOrderId(const utility::string_t& value)
{
    m_Exchange_order_id = value;
    m_Exchange_order_idIsSet = true;
}

bool ExecutionReport::exchangeOrderIdIsSet() const
{
    return m_Exchange_order_idIsSet;
}

void ExecutionReport::unsetExchange_order_id()
{
    m_Exchange_order_idIsSet = false;
}
double ExecutionReport::getAmountOpen() const
{
    return m_Amount_open;
}

void ExecutionReport::setAmountOpen(double value)
{
    m_Amount_open = value;
    m_Amount_openIsSet = true;
}

bool ExecutionReport::amountOpenIsSet() const
{
    return m_Amount_openIsSet;
}

void ExecutionReport::unsetAmount_open()
{
    m_Amount_openIsSet = false;
}
double ExecutionReport::getAmountFilled() const
{
    return m_Amount_filled;
}

void ExecutionReport::setAmountFilled(double value)
{
    m_Amount_filled = value;
    m_Amount_filledIsSet = true;
}

bool ExecutionReport::amountFilledIsSet() const
{
    return m_Amount_filledIsSet;
}

void ExecutionReport::unsetAmount_filled()
{
    m_Amount_filledIsSet = false;
}
std::shared_ptr<OrdStatus> ExecutionReport::getStatus() const
{
    return m_Status;
}

void ExecutionReport::setStatus(const std::shared_ptr<OrdStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ExecutionReport::statusIsSet() const
{
    return m_StatusIsSet;
}

void ExecutionReport::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::vector<utility::string_t>>& ExecutionReport::getTimeOrder()
{
    return m_Time_order;
}

void ExecutionReport::setTimeOrder(const std::vector<std::vector<utility::string_t>>& value)
{
    m_Time_order = value;
    m_Time_orderIsSet = true;
}

bool ExecutionReport::timeOrderIsSet() const
{
    return m_Time_orderIsSet;
}

void ExecutionReport::unsetTime_order()
{
    m_Time_orderIsSet = false;
}
utility::string_t ExecutionReport::getErrorMessage() const
{
    return m_Error_message;
}

void ExecutionReport::setErrorMessage(const utility::string_t& value)
{
    m_Error_message = value;
    m_Error_messageIsSet = true;
}

bool ExecutionReport::errorMessageIsSet() const
{
