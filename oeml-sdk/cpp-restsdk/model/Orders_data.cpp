...
void Orders_data::validate()
{
    // TODO: implement validation
}

web::json::value Orders_data::toJson() const
{
...
bool Orders_data::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Orders_data::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Orders_data::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t Orders_data::getExchangeId() const
{
    return m_Exchange_id;
}

void Orders_data::setExchangeId(const utility::string_t& value)
{
    m_Exchange_id = value;
    m_Exchange_idIsSet = true;
}

bool Orders_data::exchangeIdIsSet() const
{
    return m_Exchange_idIsSet;
}

void Orders_data::unsetExchange_id()
{
    m_Exchange_idIsSet = false;
}
utility::string_t Orders_data::getId() const
{
    return m_Id;
}

void Orders_data::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Orders_data::idIsSet() const
{
    return m_IdIsSet;
}

void Orders_data::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Orders_data::getClientOrderIdFormatExchange() const
{
    return m_Client_order_id_format_exchange;
}

void Orders_data::setClientOrderIdFormatExchange(const utility::string_t& value)
{
    m_Client_order_id_format_exchange = value;
    m_Client_order_id_format_exchangeIsSet = true;
}

bool Orders_data::clientOrderIdFormatExchangeIsSet() const
{
    return m_Client_order_id_format_exchangeIsSet;
}

void Orders_data::unsetClient_order_id_format_exchange()
{
    m_Client_order_id_format_exchangeIsSet = false;
}
utility::string_t Orders_data::getExchangeOrderId() const
{
    return m_Exchange_order_id;
}

void Orders_data::setExchangeOrderId(const utility::string_t& value)
{
    m_Exchange_order_id = value;
    m_Exchange_order_idIsSet = true;
}

bool Orders_data::exchangeOrderIdIsSet() const
{
    return m_Exchange_order_idIsSet;
}

void Orders_data::unsetExchange_order_id()
{
    m_Exchange_order_idIsSet = false;
}
double Orders_data::getAmountOpen() const
{
    return m_Amount_open;
}

void Orders_data::setAmountOpen(double value)
{
    m_Amount_open = value;
    m_Amount_openIsSet = true;
}

bool Orders_data::amountOpenIsSet() const
{
    return m_Amount_openIsSet;
}

void Orders_data::unsetAmount_open()
{
    m_Amount_openIsSet = false;
}
double Orders_data::getAmountFilled() const
{
    return m_Amount_filled;
}

void Orders_data::setAmountFilled(double value)
{
    m_Amount_filled = value;
    m_Amount_filledIsSet = true;
}

bool Orders_data::amountFilledIsSet() const
{
    return m_Amount_filledIsSet;
}

void Orders_data::unsetAmount_filled()
{
    m_Amount_filledIsSet = false;
}
std::shared_ptr<OrdStatus> Orders_data::getStatus() const
{
    return m_Status;
}

void Orders_data::setStatus(const std::shared_ptr<OrdStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Orders_data::statusIsSet() const
{
    return m_StatusIsSet;
}

void Orders_data::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::vector<utility::string_t>>& Orders_data::getTimeOrder()
{
    return m_Time_order;
}

void Orders_data::setTimeOrder(const std::vector<std::vector<utility::string_t>>& value)
{
    m_Time_order = value;
    m_Time_orderIsSet = true;
}

bool Orders_data::timeOrderIsSet() const
{
    return m_Time_orderIsSet;
}

void Orders_data::unsetTime_order()
{
    m_Time_orderIsSet = false;
}
utility::string_t Orders_data::getErrorMessage() const
{
    return m_Error_message;
}

void Orders_data::setErrorMessage(const utility::string_t& value)
{
    m_Error_message = value;
    m_Error_messageIsSet = true;
}

bool Orders_data::errorMessageIsSet() const
{
    return m_Error_messageIsSet;
}

void Orders_data::unsetError_message()
{
    m_Error_messageIsSet = false;
}
utility::string_t Orders_data::getClientOrderId() const
{
    return m_Client_order_id;
}

void Orders_data::setClientOrderId(const utility::string_t& value)
{
    m_Client_order_id = value;
    m_Client_order_idIsSet = true;
}

bool Orders_data::clientOrderIdIsSet() const
{
    return m_Client_order_idIsSet;
}

void Orders_data::unsetClient_order_id()
{
    m_Client_order_idIsSet = false;
}
utility::string_t Orders_data::getSymbolExchange() const
{
    return m_Symbol_exchange;
}

void Orders_data::setSymbolExchange(const utility::string_t& value)
{
    m_Symbol_exchange = value;
    m_Symbol_exchangeIsSet = true;
}

bool Orders_data::symbolExchangeIsSet() const
{
    return m_Symbol_exchangeIsSet;
}

void Orders_data::unsetSymbol_exchange()
{
    m_Symbol_exchangeIsSet = false;
}
utility::string_t Orders_data::getSymbolCoinapi() const
{
    return m_Symbol_coinapi;
}

void Orders_data::setSymbolCoinapi(const utility::string_t& value)
{
    m_Symbol_coinapi = value;
    m_Symbol_coinapiIsSet = true;
}

bool Orders_data::symbolCoinapiIsSet() const
{
    return m_Symbol_coinapiIsSet;
}

void Orders_data::unsetSymbol_coinapi()
{
    m_Symbol_coinapiIsSet = false;
}
double Orders_data::getAmountOrder() const
{
    return m_Amount_order;
}

void Orders_data::setAmountOrder(double value)
{
    m_Amount_order = value;
    m_Amount_orderIsSet = true;
}

bool Orders_data::amountOrderIsSet() const
{
    return m_Amount_orderIsSet;
}

void Orders_data::unsetAmount_order()
{
    m_Amount_orderIsSet = false;
}
double Orders_data::getPrice() const
{
    return m_Price;
}

void Orders_data::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}

bool Orders_data::priceIsSet() const
{
    return m_PriceIsSet;
}

void Orders_data::unsetPrice()
{
    m_PriceIsSet = false;
}
utility::string_t Orders_data::getSide() const
{
    return m_Side;
}

void Orders_data::setSide(const utility::string_t& value)
{
    m_Side = value;
    m_SideIsSet = true;
}

bool Orders_data::sideIsSet() const
{
    return m_SideIsSet;
}

void Orders_data::unsetSide()
{
    m_SideIsSet = false;
}
utility::string_t Orders_data::getOrderType() const
{
    return m_Order_type;
}

void Orders_data::setOrderType(const utility::string_t& value)
{
    m_Order_type = value;
    m_Order_typeIsSet = true;
}

bool Orders_data::orderTypeIsSet() const
{
    return m_Order_typeIsSet;
}

void Orders_data::unsetOrder_type()
{
    m_Order_typeIsSet = false;
}
std::shared_ptr<TimeInForce> Orders_data::getTimeInForce() const
{
    return m_Time_in_force;
}

void Orders_data::setTimeInForce(const std::shared_ptr<TimeInForce>& value)
{
    m_Time_in_force = value;
    m_Time_in_forceIsSet = true;
}

bool Orders_data::timeInForceIsSet() const
{
    return m_Time_in_forceIsSet;
}

void Orders_data::unsetTime_in_force()
{
    m_Time_in_forceIsSet = false;
}
std::shared_ptr<utility::datetime> Orders_data::getExpireTime() const
{
    return m_Expire_time;
}

void Orders_data::setExpireTime(const std::shared_ptr<utility::datetime>& value)
{
    m_Expire_time = value;
    m_Expire_timeIsSet = true;
}

bool Orders_data::expireTimeIsSet() const
{
    return m_Expire_timeIsSet;
}

void Orders_data::unsetExpire_time()
{
    m_Expire_timeIsSet = false;
}
std::vector<utility::string_t>& Orders_data::getExecInst()
{
    return m_Exec_inst;
}

void Orders_data::setExecInst(const std::vector<utility::string_t>& value)
{
    m_Exec_inst = value;
    m_Exec_instIsSet = true;
}

bool Orders_data::execInstIsSet() const
{
    return m_Exec_instIsSet;
}

void Orders_data::unsetExec_inst()
{
    m_Exec_instIsSet = false;
}
}
