...
case class OrdersData (
  ...
  /* Buy or Sell */
  side: Option[OrdersDataEnums.Side] = None,
  /* The order type. */
  orderType: Option[OrdersDataEnums.OrderType] = None,
  timeInForce: Option[TimeInForce] = None,
  /* Required for orders with time_in_force = GOOD_TILL_TIME_EXCHANGE, GOOD_TILL_TIME_OMS */
  expireTime: Option[LocalDate] = None,
  /* Order execution instructions are documented in the separate section: <a href=\"#oeml-order-params-exec\">OEML / Starter Guide / Order parameters / Execution instructions</a> */
  execInst: Option[OrdersDataEnums.Seq[ExecInst]] = None
) extends ApiModel

object OrdersDataEnums {
