...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OemlRestApi.NewOrderSingle();
  });
  ...
  describe('NewOrderSingle', function() {
    it('should create an instance of NewOrderSingle', function() {
      // uncomment below and update the code to test NewOrderSingle
      //var instane = new OemlRestApi.NewOrderSingle();
      //expect(instance).to.be.a(OemlRestApi.NewOrderSingle);
    });
