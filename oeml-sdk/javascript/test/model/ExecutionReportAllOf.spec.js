...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OemlRestApi.ExecutionReportAllOf();
  });
  ...
  describe('ExecutionReportAllOf', function() {
    it('should create an instance of ExecutionReportAllOf', function() {
      // uncomment below and update the code to test ExecutionReportAllOf
      //var instane = new OemlRestApi.ExecutionReportAllOf();
      //expect(instance).to.be.a(OemlRestApi.ExecutionReportAllOf);
    });
