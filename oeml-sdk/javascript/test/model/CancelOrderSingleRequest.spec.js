...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OemlRestApi.CancelOrderSingleRequest();
  });
  ...
  describe('CancelOrderSingleRequest', function() {
    it('should create an instance of CancelOrderSingleRequest', function() {
      // uncomment below and update the code to test CancelOrderSingleRequest
      //var instane = new OemlRestApi.CancelOrderSingleRequest();
      //expect(instance).to.be.a(OemlRestApi.CancelOrderSingleRequest);
    });
