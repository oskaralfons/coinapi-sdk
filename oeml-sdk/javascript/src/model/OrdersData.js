 ...
 */
OrdersData.prototype['exchange_id'] = undefined;

/**
 * Client unique identifier for the trade.
 * @member {String} id
 */
OrdersData.prototype['id'] = undefined;

/**
 * Hash client id
 * @member {String} client_order_id_format_exchange
 */
OrdersData.prototype['client_order_id_format_exchange'] = undefined;

/**
 * Exchange order id
 * @member {String} exchange_order_id
 */
OrdersData.prototype['exchange_order_id'] = undefined;

/**
 * Amount open
 * @member {Number} amount_open
 */
OrdersData.prototype['amount_open'] = undefined;

/**
 * Amount filled
 * @member {Number} amount_filled
 */
OrdersData.prototype['amount_filled'] = undefined;

/**
 * @member {module:model/OrdStatus} status
 */
OrdersData.prototype['status'] = undefined;

/**
 * History of order status changes
 * @member {Array.<Array.<String>>} time_order
 */
OrdersData.prototype['time_order'] = undefined;

/**
 * Error message
 * @member {String} error_message
 */
OrdersData.prototype['error_message'] = undefined;

/**
 * Client unique identifier for the trade.
 * @member {String} client_order_id
 */
OrdersData.prototype['client_order_id'] = undefined;

/**
 * The symbol of the order.
 * @member {String} symbol_exchange
 */
OrdersData.prototype['symbol_exchange'] = undefined;

/**
 * The CoinAPI symbol of the order.
 * @member {String} symbol_coinapi
 */
OrdersData.prototype['symbol_coinapi'] = undefined;

/**
 * Quoted decimal amount to purchase.
 * @member {Number} amount_order
 */
OrdersData.prototype['amount_order'] = undefined;

/**
 * Quoted decimal amount to spend per unit.
 * @member {Number} price
 */
OrdersData.prototype['price'] = undefined;

/**
 * Buy or Sell
 * @member {module:model/OrdersData.SideEnum} side
 */
OrdersData.prototype['side'] = undefined;

/**
 * The order type.
 * @member {module:model/OrdersData.OrderTypeEnum} order_type
 */
OrdersData.prototype['order_type'] = undefined;

/**
 * @member {module:model/TimeInForce} time_in_force
 */
OrdersData.prototype['time_in_force'] = undefined;

/**
 * Required for orders with time_in_force = GOOD_TILL_TIME_EXCHANGE, GOOD_TILL_TIME_OMS
 * @member {Date} expire_time
 */
OrdersData.prototype['expire_time'] = undefined;

/**
 * Order execution instructions are documented in the separate section: <a href=\"#oeml-order-params-exec\">OEML / Starter Guide / Order parameters / Execution instructions</a>
 * @member {Array.<module:model/OrdersData.ExecInstEnum>} exec_inst
 */
OrdersData.prototype['exec_inst'] = undefined;
