...
typedef enum { oeml___rest_api_time_in_force__NULL = 0, oeml___rest_api_time_in_force__GOOD_TILL_CANCEL, oeml___rest_api_time_in_force__GOOD_TILL_TIME_EXCHANGE, oeml___rest_api_time_in_force__GOOD_TILL_TIME_OMS, oeml___rest_api_time_in_force__FILL_OR_KILL, oeml___rest_api_time_in_force__IMMEDIATE_OR_CANCEL, oeml___rest_api_time_in_force__AUCTION_ONLY, oeml___rest_api_time_in_force__INDICATION_OF_INTEREST } oeml___rest_api_time_in_force__e;
