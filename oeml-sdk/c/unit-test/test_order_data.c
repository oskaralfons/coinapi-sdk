...
order_data_t* instantiate_order_data(int include_optional) {
  ...
  if (include_optional) {
    order_data = order_data_create(
      ...
      0.22,
      0.0,
      oeml___rest_api_order_data__RECEIVED,
      list_create(),
      ...
      0.045,
      0.0783,
      oeml___rest_api_order_data_SIDE_"BUY",
      oeml___rest_api_order_data_ORDERTYPE_"LIMIT",
      oeml___rest_api_order_data__GOOD_TILL_CANCEL,
      null,
      list_create()
    );
  } else {
