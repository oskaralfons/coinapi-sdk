...
# Unit tests for OpenapiClient::OrdersData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OrdersData' do
  before do
    # run before each test
    @instance = OpenapiClient::OrdersData.new
  end
  ...
  describe 'test an instance of OrdersData' do
    it 'should create an instance of OrdersData' do
      expect(@instance).to be_instance_of(OpenapiClient::OrdersData)
    end
  end
