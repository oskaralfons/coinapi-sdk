...
# Unit tests for OpenapiClient::NewOrderSingle
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NewOrderSingle' do
  before do
    # run before each test
    @instance = OpenapiClient::NewOrderSingle.new
  end
  ...
  describe 'test an instance of NewOrderSingle' do
    it 'should create an instance of NewOrderSingle' do
      expect(@instance).to be_instance_of(OpenapiClient::NewOrderSingle)
    end
  end
