function New-OrdersData {
    ...
    Process {
        'Creating object: Org.OpenAPITools.Model.OrdersData' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName Org.OpenAPITools.Model.OrdersData -ArgumentList @(
            ${exchangeUnderscoreid},
            ${id},
            ${clientUnderscoreorderUnderscoreidUnderscoreformatUnderscoreexchange},
            ${exchangeUnderscoreorderUnderscoreid},
