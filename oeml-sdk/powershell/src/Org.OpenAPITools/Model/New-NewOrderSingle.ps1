function New-NewOrderSingle {
    ...
    Process {
        'Creating object: Org.OpenAPITools.Model.NewOrderSingle' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName Org.OpenAPITools.Model.NewOrderSingle -ArgumentList @(
            ${exchangeUnderscoreid},
            ${clientUnderscoreorderUnderscoreid},
            ${symbolUnderscoreexchange},
            ${symbolUnderscorecoinapi},
