...
class OrdersData {
  ...
  static List<OrdersData> listFromJson(List<dynamic> json) {
    return json == null ? List<OrdersData>() : json.map((value) => OrdersData.fromJson(value)).toList();
  }

  static Map<String, OrdersData> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, OrdersData>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = OrdersData.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of OrdersData-objects as value to a dart map
  static Map<String, List<OrdersData>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<OrdersData>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = OrdersData.listFromJson(value);
       });
     }
     return map;
  }
