...
class ExecutionReport {
  ...
  static List<ExecutionReport> listFromJson(List<dynamic> json) {
    return json == null ? List<ExecutionReport>() : json.map((value) => ExecutionReport.fromJson(value)).toList();
  }

  static Map<String, ExecutionReport> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, ExecutionReport>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = ExecutionReport.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ExecutionReport-objects as value to a dart map
  static Map<String, List<ExecutionReport>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<ExecutionReport>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = ExecutionReport.listFromJson(value);
       });
     }
     return map;
  }
